...
export class WindowService {
  ...
  public createMainWindow(): BrowserWindow {
    ...
    this.mainWindow = new BrowserWindow({
      ...
      titleBarOverlay: isLinux ? undefined : (nativeTheme.shouldUseDarkColors ? titleBarOverlayDark : titleBarOverlayLight),
      backgroundColor: isMac ? undefined : (isLinux ? undefined : (nativeTheme.shouldUseDarkColors ? '#181818' : '#FFFFFF')),
